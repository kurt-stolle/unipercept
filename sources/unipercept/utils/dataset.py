...
class DatasetMeta(abc.ABCMeta):
    ...
    def __new__(metacls, name, bases, ns, *, extra_slots=(), **kwds):
        ...
        ds_cls = D.dataclass(slots=has_slots, weakref_slot=has_slots, kw_only=True)(
            ds_cls
        )  # type: ignore
