...
DEFAULT_LABEL_FLAGS = LabelFlags.ID | LabelFlags.CLASS
...
class Visualizer:
    def __init__(
        ...
        self._default_font_size = max(np.sqrt(self.output.height * self.output.width) // 60, 11 // scale)
    ...
    def get_mask_label(self, sem_id, ins_id=0, labels: LabelFlags = LabelFlags.ID | LabelFlags.CLASS):
        lbl = []
    ...
    def draw_segmentation(
        ...
        *,
        ...
        area_threshold=None,
        alpha=0.7,
        labels: LabelFlags = LabelFlags.ID | LabelFlags.CLASS,
    ):
        """
