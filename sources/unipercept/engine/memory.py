...
MetricsDictType: T.TypeAlias = dict[str, T.Any]
...
class MemoryTracker:
    ...
    cur_stage: str | None = D.field(default=None, init=False)
    ...
    gpu_mem_used_at_start: int | None = D.field(default=None, init=False)
    gpu_mem_used_peak: int | None = D.field(default=None, init=False)
    gpu_mem_used_now: int | None = D.field(default=None, init=False)
    cpu_mem_used_at_start: int | None = D.field(default=None, init=False)
    cpu_mem_used_peak: int | None = D.field(default=None, init=False)
    cpu_mem_used_now: int | None = D.field(default=None, init=False)
    peak_monitoring: bool | None = D.field(default=None, init=False)
