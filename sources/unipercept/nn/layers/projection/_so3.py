...
def so3_exponential_map(log_rot: Tensor, eps: float = 0.0001) -> Tensor:
    warnings.warn(
...
def so3_log_map(R: Tensor, eps: float = 0.0001, cos_bound: float = 1e-4) -> Tensor:
    """
