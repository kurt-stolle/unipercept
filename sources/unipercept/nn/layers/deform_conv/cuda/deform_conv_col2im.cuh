...
void deform_conv_col2im_cuda(
  ...
  if (size_scalar == 2) {
    switch (d_stride) {
    case 1:
      _deform_conv_col2im_cuda<scalar_t, scalar_t, 1>(
      ...
      break;
    case 2:
      _deform_conv_col2im_cuda<scalar_t, uint, 2>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 4:
      _deform_conv_col2im_cuda<scalar_t, uint2, 4>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 8:
      _deform_conv_col2im_cuda<scalar_t, uint4, 8>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 16:
      _deform_conv_col2im_cuda<scalar_t, ulonglong4, 16>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
    ...
    switch (d_stride) {
    case 1:
      _deform_conv_col2im_cuda<scalar_t, uint, 1>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 2:
      _deform_conv_col2im_cuda<scalar_t, uint2, 2>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 4:
      _deform_conv_col2im_cuda<scalar_t, uint4, 4>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
      break;
    case 8:
      _deform_conv_col2im_cuda<scalar_t, ulonglong4, 8>(
          stream, value, p_offset, grad_output, kernel_h, kernel_w, stride_h,
          stride_w, pad_h, pad_w, dilation_h, dilation_w, G, D, B, height_in,
          width_in, height_out, width_out, offset_scale, remove_center, grad_im,
          grad_offset, block_thread, softmax, padded_offset_dim);
