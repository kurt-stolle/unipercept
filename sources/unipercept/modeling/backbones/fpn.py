...
import unipercept.modeling.layers as _ML
import unipercept.modeling.typings as _MT
...
_DEFAULT_NORM = _ML.norm.GlobalResponseNorm2d
    ...
    def __init__(
        ...
        *,
        ...
        if scale > 1 and downsample_mode == "conv":
            ...
            self.add_module(
                "conv",
                _ML.conv.Standard2d.with_norm_activation(
                    in_channels,
                    out_channels,
                    kernel_size=1,
                    stride=1,
