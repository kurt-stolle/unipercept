...
CLASSES_AS_CITYSCAPES = [
    SClass(color=(165, 42, 42), kind=SType.STUFF, dataset_id=0, unified_id=255, name="animal--bird"),
    SClass(color=(0, 192, 0), kind=SType.STUFF, dataset_id=1, unified_id=255, name="animal--ground-animal"),
    SClass(color=(196, 196, 196), kind=SType.STUFF, dataset_id=2, unified_id=1, name="construction--barrier--curb"),
    SClass(color=(190, 153, 153), kind=SType.STUFF, dataset_id=3, unified_id=4, name="construction--barrier--fence"),
    SClass(
        color=(180, 165, 180),
        kind=SType.STUFF,
        dataset_id=4,
    ...
    SClass(color=(102, 102, 156), kind=SType.STUFF, dataset_id=6, unified_id=3, name="construction--barrier--wall"),
    SClass(color=(128, 64, 6), kind=SType.STUFF, dataset_id=7, unified_id=0, name="construction--flat--bike-lane"),
    SClass(
        color=(140, 140, 200),
        kind=SType.STUFF,
        dataset_id=8,
    ...
    SClass(color=(170, 170, 170), kind=SType.STUFF, dataset_id=9, unified_id=1, name="construction--flat--curb-cut"),
    SClass(color=(250, 170, 160), kind=SType.STUFF, dataset_id=10, unified_id=255, name="construction--flat--parking"),
    SClass(
        color=(96, 96, 96),
        kind=SType.STUFF,
        dataset_id=11,
    ...
    SClass(color=(128, 64, 128), kind=SType.STUFF, dataset_id=13, unified_id=0, name="construction--flat--road"),
    SClass(
        color=(110, 110, 110),
        kind=SType.STUFF,
        dataset_id=14,
    ...
    SClass(color=(244, 35, 232), kind=SType.STUFF, dataset_id=15, unified_id=1, name="construction--flat--sidewalk"),
    SClass(
        color=(150, 100, 100),
        kind=SType.STUFF,
        dataset_id=16,
    ...
    SClass(color=(70, 70, 70), kind=SType.STUFF, dataset_id=17, unified_id=2, name="construction--structure--building"),
    SClass(
        color=(150, 120, 90),
        kind=SType.STUFF,
        dataset_id=18,
    ...
    SClass(color=(230, 160, 50), kind=SType.STUFF, dataset_id=26, unified_id=9, name="nature--sand"),
    SClass(color=(70, 130, 180), kind=SType.STUFF, dataset_id=27, unified_id=10, name="nature--sky"),
    SClass(color=(190, 6, 6), kind=SType.STUFF, dataset_id=28, unified_id=255, name="nature--snow"),
    SClass(color=(152, 251, 152), kind=SType.STUFF, dataset_id=29, unified_id=9, name="nature--terrain"),
    SClass(color=(107, 142, 35), kind=SType.STUFF, dataset_id=30, unified_id=8, name="nature--vegetation"),
    SClass(color=(0, 170, 130), kind=SType.STUFF, dataset_id=31, unified_id=255, name="nature--water"),
    SClass(color=(6, 6, 128), kind=SType.STUFF, dataset_id=32, unified_id=255, name="object--banner"),
    SClass(color=(250, 0, 30), kind=SType.STUFF, dataset_id=33, unified_id=255, name="object--bench"),
    SClass(color=(100, 140, 180), kind=SType.STUFF, dataset_id=34, unified_id=255, name="object--bike-rack"),
    SClass(color=(220, 220, 220), kind=SType.STUFF, dataset_id=35, unified_id=255, name="object--billboard"),
    SClass(color=(220, 128, 128), kind=SType.STUFF, dataset_id=36, unified_id=255, name="object--catch-basin"),
    SClass(color=(222, 40, 40), kind=SType.STUFF, dataset_id=37, unified_id=255, name="object--cctv-camera"),
    SClass(color=(100, 170, 30), kind=SType.STUFF, dataset_id=38, unified_id=255, name="object--fire-hydrant"),
    SClass(color=(40, 40, 40), kind=SType.STUFF, dataset_id=39, unified_id=255, name="object--junction-box"),
    SClass(color=(33, 33, 33), kind=SType.STUFF, dataset_id=40, unified_id=255, name="object--mailbox"),
    SClass(color=(100, 128, 160), kind=SType.STUFF, dataset_id=41, unified_id=0, name="object--manhole"),
    SClass(color=(142, 0, 0), kind=SType.STUFF, dataset_id=42, unified_id=255, name="object--phone-booth"),
    SClass(color=(70, 100, 150), kind=SType.STUFF, dataset_id=43, unified_id=0, name="object--pothole"),
    SClass(color=(210, 170, 100), kind=SType.STUFF, dataset_id=44, unified_id=5, name="object--street-light"),
    SClass(color=(153, 153, 153), kind=SType.STUFF, dataset_id=45, unified_id=5, name="object--support--pole"),
    SClass(
        color=(128, 128, 128),
        kind=SType.STUFF,
        dataset_id=46,
    ...
    SClass(color=(0, 0, 80), kind=SType.STUFF, dataset_id=47, unified_id=5, name="object--support--utility-pole"),
    SClass(color=(250, 170, 30), kind=SType.STUFF, dataset_id=48, unified_id=6, name="object--traffic-light"),
    ...
    SClass(color=(0, 0, 0), kind=SType.STUFF, dataset_id=65, unified_id=255, name="void--unlabeled"),
]
CLASSES = [
    SClass(color=(165, 42, 42), kind=SType.STUFF, dataset_id=0, unified_id=255, name="animal--bird"),
    SClass(color=(0, 192, 0), kind=SType.STUFF, dataset_id=1, unified_id=255, name="animal--ground-animal"),
