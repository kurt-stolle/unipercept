...
def se3_exp_map(log_transform: Tensor, eps: float = 1e-4) -> Tensor:
    """
...
def _se3_V_matrix(
    log_rotation: Tensor,
    log_rotation_hat: Tensor,
    log_rotation_hat_square: Tensor,
...
def _get_se3_V_input(log_rotation: Tensor, eps: float = 1e-4):
    """
