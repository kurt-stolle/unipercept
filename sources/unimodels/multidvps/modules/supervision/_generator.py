...
from ._assign_stuff import StuffAssigner
from ._assign_things import ThingAssigner
from ._truths import Truths
...
class TruthGenerator(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs.pop("label_divisor", None) is not None:
            warnings.warn("label_divisor is deprecated", stacklevel=2)
    ...
    def from_metadata(cls, name: str, **kwargs) -> T.Self:
        ...
        return cls(
            thing_embeddings=info.thing_embeddings,
            stuff_embeddings=info.stuff_embeddings,
